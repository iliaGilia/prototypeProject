...
from . import views
from .views.profile.profile_views import get_authenticated_user,upload_profile_image
from .views.chart.chart_views import ChartList,ChartDetail
...
urlpatterns = [
    ...
    path('api/charts/', ChartList.as_view(), name='chart-list'),
    path('api/charts/<int:pk>/', ChartDetail.as_view(), name='chart-detail'),
